<template>
  <v-card>
    <v-card-title>
      ...
      ></v-text-field>
      <v-spacer></v-spacer>
      <router-link to="/StatusOportunidadeForm">
...
query($first:Int, $offset:Int){
    statusOportunidades(first: $first, offset: $offset) {
    nodes {
      descricao
      id
    }
...
`,
  ...
  "offset": ${this.pagination.rowsPerPage * (this.pagination.page - 1)}
        ...
        this.items = e.data.data.statusOportunidades.nodes;
        this.loading = false;
        this.pagination.totalItems = e.data.data.statusOportunidades.totalCount;
      });
    }
  },
  mounted() {
